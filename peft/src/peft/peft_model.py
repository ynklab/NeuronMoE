    ...
    **Attributes**:
    ...
    def from_pretrained(
        ...
        **kwargs: Any,
        ...
        # print(model)
        # print(model.base_model.model.model.layers[0].mlp)
        # print(model.base_model.model.model.layers[0].mlp.spe_agn_hard_route)
    ...
    def load_adapter(self, model_id: str, adapter_name: str, is_trainable: bool = False, **kwargs: Any):
        ...
        print("!!!-load_adapter-self.peft_config", self.peft_config)
